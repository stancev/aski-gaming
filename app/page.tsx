    ...
    >
      <div className="w-full xl:max-w-[1440px] flex flex-col xl:flex-row">
        <div className="flex flex-1 flex-col justify-center items-center xl:items-start text-center xl:text-left px-4 pt-11 lg:pt-14">
          <h1 className="font-family:'Poppins-SemiBold',Helvetica] font-semibold text-white text-[24px] md:text-[28px] lg:text-[46px] leading-normal md:leading-[57px] xl:leading-[77.8px]">
            Browse, Connect, Review
          </h1>
          <p className="[font-family:'Poppins-Medium',Helvetica] font-medium text-white text-[14px] lg:text-[20px] xl:text-[24px] leading-normal xl:leading-[30.1px] mt-3 mb-3">
